...
function UI:Initialize()
    ...
    self.columns = {
        ...
        { key = "signetMoonlitWater", label = "Moonlit Ring", width = 90, defaultWidth = 90, profession = ns.ProfessionKeys.Tailoring },
        { key = "saltShaker", label = "Salt Shaker", width = 90, defaultWidth = 90, profession = ns.ProfessionKeys.Leatherworking },
        { key = "customTrinket", label = "MW Saltshaker", width = 80, defaultWidth = 80, profession = ns.ProfessionKeys.Leatherworking },

        { key = "transmuteArcanite", label = "Arcanite", width = 80, defaultWidth = 80, profession = ns.ProfessionKeys.Alchemy },
        { key = "alchemyItem", label = "Lattice", width = 90, defaultWidth = 90, profession = ns.ProfessionKeys.Alchemy },
    }
    self.rows = {}
...
function UI:RefreshDisplay()
    ...
    for charKey, charData in pairs(charTable) do
        ...
        local mrText = self:GetCooldownText(charKey, ns.ProfessionKeys.Tailoring,      "signetMoonlitWater")
        ...
        if mText == "-" and mrText == "-" and sText == "-" and cText == "-" and tText == "-" and aText == "-" then
            ...
            if mrText ~= "-" then activeColumns["signetMoonlitWater"]  = true end
